...
import { react as reactAction } from '@/app/actions';
...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {feed.map((p: any) => {
        // Server Actions “preligadas” al post actual
        const like = reactAction.bind(null, p.id, 'heart' as const);
        const fire = reactAction.bind(null, p.id, 'fire' as const);
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-2 flex items-center gap-3 text-sm">
                ...
                <form action={like}>
                  ...
                  >
                    <span>❤️</span>
                    <span>{countReactions(p.reactions, 'heart')}</span>
                  </button>
                </form>
